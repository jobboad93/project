...
function Forgive() {
  ...
  const moveNoButton = () => {
    ...
    do {
      ...
      (newTop > 40 && newTop < 60 && newLeft > 40 && newLeft < 60)
    );
        ...
        {!accepted ? (
          ...
          >
            ...
            <div className="flex justify-center gap-12 relative min-h-[250px] items-center">
              ...
              {/* YES Button - Matching background */}
              <motion.button
                whileHover={{ 
                  scale: 1.08,
              ...
              {/* NO Button - Moves all over screen */}
              <motion.button
                ...
                className="absolute px-8 py-4 bg-white/15 backdrop-blur-md text-white/90 rounded-xl text-xl font-semibold shadow-2xl border-2 border-white/30 cursor-pointer z-50 hover:bg-white/25"
                style={{ 
                  position: "absolute",
          ...
          >
            ...
            <motion.p 
              ...
              transition={{ duration: 3, repeat: Infinity }}
            >
              Tnank you.. Sahithi... na sorry accept chesinandhuku.. ✨
            </motion.p>
